  ...
  {"Our platform provides secure complaint registration with emergency SOS features...".split("").map((char, index) => (
    <span key={index} style={{ '--i': index }}>
      {char === " " ? "\u00A0" : char}
        ...
        {/* Officer Dashboard Button added at the bottom of the page */}
        <div className="text-center pb-8">
          <button 
            onClick={() => navigate('/officer')}
            className="px-8 py-4 bg-blue-700 hover:bg-blue-800 border-2 border-blue-400 text-white shadow-lg shadow-blue-500/50 rounded-full text-xl transition-all duration-300 flex items-center mx-auto"
          >
